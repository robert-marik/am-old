...
Vypočtěte divergence vektorového pole $$\vec F=x^2y\vec \imath + (x+y^2)\vec \jmath$$
...
Vypočtěte divergence vektorového pole $$\vec F=ax^3y^2\vec \imath + 3x^2y\vec \jmath,$$ kde $a\in\mathbb R$ je reálný parametr.
