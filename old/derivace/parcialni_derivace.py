...
zorder=-10
ax.plot([x0,x0,x0],[y0,y0,ymin],[f(x0,y0),0,0],'--', zorder=zorder, color='gray')
ax.plot([x0,xmax],[y0,y0],[0,0],'--', color='gray', zorder=zorder)
