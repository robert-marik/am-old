...
stred_text ( (x3[0], funkce(x3[0])) , (x3[1], funkce(x3[1])) , r"$\Delta s$",fontsize=fontsize, ha='left', va='top', alpha=alpha, color='red', bbox=bbox_props )
...
ax.text(0.5*(xmin+xmax),(10*ymin + ymax)/11,r"$\Delta s\approx \sqrt{\strut(\varphi'(t))^2+(\psi'(t))^2}\,\Delta t$", fontsize=25, ha='center' , bbox=bbox_props )
...
fig.savefig("delkovy_element.png",bbox_inches="tight",\
	pad_inches=.15)
